...
from process.sabangnet_regist_upload_process import SabangnetRegistUploadProcess

import debugpy


class SabangnetRegistUploadThread(QThread):
    log_msg = pyqtSignal(str)
    regist_upload_finished = pyqtSignal()
    ...
    def run(self):
        try:
            ...
            process = SabangnetRegistUploadProcess()
        ...
        self.regist_upload_finished.emit()
